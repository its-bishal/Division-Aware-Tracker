...
class Track:
    ...
    def _get_seg_ious(self, regs):
        """
        Calculates exactly half of the standard Dice coefficient(2 * Intersection / (Area A + Area B))
        between the reference mask and the given masks.
        This is equivalent to the Intersection over Union (IoU) metric to measure by how much two masks overlap.
        """
